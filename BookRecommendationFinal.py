...
# DATA FRAME
dataset1=pd.read_csv("C:/Users/POURNIMA/Project 1/Deployment/dataset1.csv")
model = pickle.load(open(r"C:\Users\POURNIMA\Project 1\Deployment\model.pkl", "rb"))
final= pickle.load(open(r"C:\Users\POURNIMA\Project 1\Deployment\final.pkl", "rb"))
books_name=pickle.load(open(r"C:\Users\POURNIMA\Project 1\Deployment\books_name.pkl","rb"))
popularity=pickle.load(open(r'C:\Users\POURNIMA\Project 1\Deployment\popularity.pkl','rb'))
user=pd.read_csv(r'C:\Users\POURNIMA\Project 1\Deployment\Users.csv')
book=pd.read_csv(r'C:\Users\POURNIMA\Project 1\Deployment\Books.csv')
rating=pd.read_csv(r'C:\Users\POURNIMA\Project 1\Deployment\Ratings.csv')
...
add_bg_from_local('C:/Users/POURNIMA/Project 1/Deployment/WhatsApp Image 2022-11-29 at 4.30.34 PM.jpeg')
...
image = Image.open('C:/Users/POURNIMA/Project 1/Deployment/Navi.jpg')
